...
| 住宅（小） | 1×1 | 人口 +10 |
| 住宅（大） | 2×2 | 人口 +50 |
| 公園（小） | 1×1 | 隣接する住宅（小）ごとに人口 +5、住宅（大）ごとに人口 +10（最大+40） |
| 病院 | 2×2 | 町内の住宅（小）ごとに人口 +5、住宅（大）ごとに人口 +10（配置順不問） |
| 商業施設 | 1×1 | 歩数同期コイン +10% |
| 農場 | 2×2 | 人口 +20 |
| 道路 | 1×1 | 上下左右の隣接土地へ建物を配置可能 |
| 役所 | 2×2 | 町内の住宅（小）ごとに人口 +20、住宅（大）ごとに人口 +30（配置順不問） |
| 工場 | 2×2 | 歩数同期コイン +25% |

コストは現行カタログ値を使用する。効果と重複ルールは [建物効果仕様.md](./建物効果仕様.md) を正本とする。
