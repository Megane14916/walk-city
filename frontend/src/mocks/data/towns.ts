...
export const MOCK_BUILDING_CATALOG: BuildingCatalogItem[] = [
  {
    ...
    costCoins: 0,
    enabled: true,
    description: '上下左右に隣接する土地へ建物を配置可能',
    effects: [
      {
    ...
    [
      {
        ...
        stackingRule: 'unique_target',
        description: '上下左右に隣接する住宅（小）1軒につき人口を5増やします',
        metadata: {},
      },
      {
        ...
        scope: 'orthogonal_adjacent',
        stackingRule: 'unique_target',
        description: '上下左右に隣接する住宅（大）1軒につき人口を10増やします',
        metadata: {},
      },
    ],
  ),
    ...
    [
      {
        ...
        scope: 'town',
        stackingRule: 'single_source',
        description: '町内の住宅（小）1軒につき人口を20増やします',
        metadata: {},
      },
      {
        type: 'apartment_population_flat',
        ...
        scope: 'town',
        stackingRule: 'single_source',
        description: '町内の住宅（大）1軒につき人口を30増やします',
        metadata: {},
      },
    ],
  ),
